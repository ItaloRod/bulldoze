...
Item {
    ...
    // =========================================================================
    // MORPHING DYNAMIC NOTCH GREETER CARD (Top-bezel Docked)
    // =========================================================================
    Item {
        id: topNotchCard
        ...
        width: root.isExpanded ? theme.notchExpandedWidth : root.collapsedWidth
        height: root.isExpanded ? 400 : theme.notchHeight
