...
PanelWindow {
    ...
    WlrLayershell.namespace: "bulldoze-wallpaper-manager"
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            Column {
                                ...
                                Text {
                                    width: parent.width
                                    text: (root.wp && root.wp.selectedWallpaper) ? ("ID: " + root.wp.selectedWallpaper.id + " • " + (root.wp.selectedWallpaper.tags.join(", ") || "Workshop")) : ""
                                    color: theme.textMuted
                                    font.pixelSize: theme.fontSizeXs
                                    elide: Text.ElideRight
                                }
